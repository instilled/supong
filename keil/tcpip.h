...
#define MAX_TCP_TX_DATA_SIZE 2048//512                 // max. outgoing TCP data size (even!)
#define MAX_TCP_RX_DATA_SIZE 2048//256                 // max. incoming TCP data size (even!)
                                                 // (increasing the buffer-size dramatically
                                                 // increases the transfer-speed!)
                                        
#define MAX_ETH_TX_DATA_SIZE 256//60                  // 2nd buffer, used for ARP, ICMP, TCP (even!)
